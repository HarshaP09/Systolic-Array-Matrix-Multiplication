...
# Buttons (only btn[0] is used for reset in top_boolean_mm, but constrain all 4)
...
# (Optional) UART RX pin exists on the board (V12), but this design doesn't use it:
